<html lang="en"><head>
  ...
  <title>DJarit Studio</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="http://localhost/djarit-studio/assets/img/logo.svg" rel="icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Roboto:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="http://localhost/djarit-studio/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="http://localhost/djarit-studio/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="http://localhost/djarit-studio/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="http://localhost/djarit-studio/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="http://localhost/djarit-studio/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="http://localhost/djarit-studio/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="http://localhost/djarit-studio/assets/css/style.css" rel="stylesheet">
...
<body data-aos-easing="ease-in-out" data-aos-duration="1000" data-aos-delay="0">
  ...
  <header id="header" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!-- Uncomment below if you prefer to use an image logo -->
       <a href="index.html" class="logo"><img src="http://localhost/djarit-studio/assets/img/logo.png" alt=""></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#Information"><span>Information</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#Information">Informasi Jadwal Diklat</a></li>
              <li><a href="#Information">Informasi Peserta</a></li>
              <li><a href="#Information">Pengumuman</a></li>
            </ul>
          </li>
  ...
  <section id="hero" class="d-flex align-items-center scrolled-offset">
    <div class="container aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span>DJarit</span> Studio</h1>
      <h2>We Create Website Based On Your Needs</h2>
      <div class="d-flex">
        <a href="#about" class="btn-get-started scrollto">Get Started</a>
        <a href="https://www.youtube.com/embed/_N6vSc_mT6I" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
      </div>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="about" class="about section-bg">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Menjadi Web Studio Terdepan Dengan Kinerja Terbaik di Indonesia</p>
        </div>
            ...
            <ul>
              <li>
                ...
                <div>
                  <h5>Mengedepankan Profesionalisme, Kemampuan Individu dan Tim dalam Menghasilkan Produk-Produk Unggulan</h5>
                  <p></p>
                </div>
              </li>
              <li>
               <div>
                  <h5>Membangun Jaringan Kemitraan dengan Dunia Usaha</h5>
                  <p></p>
                </div>
              </li>
              <li>
               <div>
                  <h5>Mengembangkan Sumber Daya Manusia yang Unggul untuk Kemajuan Studio dalam Rangka Memenuhi Kebutuhan Klien</h5>
                  <p></p>
                </div>
              </li>
            </ul>
      ...
      <div class="container aos-init aos-animate" data-aos="zoom-in">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-1.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-2.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-3.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-4.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-5.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="http://localhost/djarit-studio/assets/img/clients/client-6.png" class="img-fluid" alt="">
          </div>
      ...
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="member-img">
                <img src="http://localhost/djarit-studio/assets/img/team/team-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
...
<div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
    ...
    <section id="Information" class="services">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Information</h2>
          <h3>Check our <span>Information</span></h3>
          <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque vitae autem.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bxl-dribbble"></i></div>
              <h4><a href="">Informasi Jadwal Diklat</a></h4>
              <p>Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="">Informasi Peserta</a></h4>
              <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore</p>
            </div>
          </div>
    ...
    <section id="pricing" class="pricing">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              <h3>Free</h3>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0 aos-init" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <h3>Developer</h3>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0 aos-init" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
...
<div class="container py-4">
  <div class="copyright">
    © Copyright <strong><span>DJarit Studio</span></strong>. All Rights Reserved
  </div>
  <div class="credits">
    Designed by <a href="http://localhost/djarit-studio/">Djarit</a>
  </div>
</div>
</footer>  <!-- End Footer -->
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center active"><i class="bi bi-arrow-up-short"></i></a>
    ...
    <!-- Vendor JS Files -->
  <script src="http://localhost/djarit-studio/assets/vendor/jquery/jquery.min.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/purecounter/purecounter.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/aos/aos.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/waypoints/noframework.waypoints.js"></script>
  <script src="http://localhost/djarit-studio/assets/vendor/php-mail-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="http://localhost/djarit-studio/assets/js/main.js"></script>
